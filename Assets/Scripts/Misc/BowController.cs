...
namespace BowArrow
{
    ...
    public class BowController : MonoBehaviour
    {
        ...
        LineRenderer TopLr;
        LineRenderer BottomLr;
        public GameObject TopOfBow;
        public GameObject BottomOfBow;
        ...
        void Start()
        {
            TopLr = GameObject.Find("topPoint").GetComponent<LineRenderer>();
            BottomLr = GameObject.Find("bottomPoint").GetComponent<LineRenderer>();
        ...
        void Update()
        {
            ...
            {
                audioManager.PlaySFX(audioManager.bowPull);
            }
        ...
        void FireProjectile()
        {
            ...
            audioManager.PlaySFX(audioManager.bowFire);
        }

        void DrawRope()
        {
            TopLr.SetPosition(0, TopOfBow.transform.position);
            TopLr.SetPosition(1, spawnPoint.transform.position); 

            BottomLr.SetPosition(0, BottomOfBow.transform.position);
            BottomLr.SetPosition(1, spawnPoint.transform.position);  
